...
Voltando à execução que já estava na tela desde o início, o mesmo `01_loopback_hil.py`: a velocidade final, média das últimas 10 amostras, chega a 100,000 radianos por segundo, erro de regime permanente de 0,00 por cento frente à referência de 100 radianos por segundo. A malha fechada funciona, com o controlador rodando fora do processo host, exatamente como funcionaria com um microcontrolador real. Mas a parte que interessa a esta aula aparece só no final da saída, na seção de estatísticas de tempo real: 200 amostras, `Ts` nominal de 5,0000 milissegundos, período médio de 5,0886 milissegundos, desvio-padrão do jitter de 0,0396 milissegundo, jitter pico a pico de 0,1369 milissegundo, latência média de 0,0888 milissegundo, latência no percentil 95 de 0,1576 milissegundo, e latência máxima de 0,2415 milissegundo. Cada uma dessas linhas é uma medição real, tirada do relógio de parede deste computador durante esta própria execução, não um valor de referência copiado de manual algum. O próximo script aprofunda exatamente essas 2 métricas, jitter e latência, sobre durações maiores.
...
O script roda a mesma malha fechada 3 vezes, com durações crescentes — meio segundo, um segundo e 2 segundos —, sempre sobre o mesmo `LoopbackTarget`, medindo 2 grandezas por ciclo: latência, o tempo entre enviar `STEP` e receber a resposta, e jitter, a variação do período efetivo do laço em torno do `Ts` nominal de 5 milissegundos. Para 100 amostras, em meio segundo, o período médio medido é 5,1260 milissegundos, o desvio-padrão do jitter é 0,0391 milissegundo, e o jitter pico a pico é 0,1103 milissegundo; a latência média fica em 0,1513 milissegundo, o percentil 95 em 0,3050 e a máxima em 0,3254 milissegundo. Para 200 amostras, em um segundo, os números sobem discretamente: desvio-padrão do jitter 0,0428, latência máxima 0,3523 milissegundo. Para 400 amostras, em 2 segundos, desvio-padrão do jitter 0,0442, latência máxima 0,4083 milissegundo. O critério de aceitação adotado nesta aula é que o desvio-padrão do jitter não ultrapasse 10 por cento do `Ts` nominal, meio milissegundo neste caso, e as 3 durações passam com folga ampla, na casa de poucos centésimos de milissegundo.
...
O prazo declarado ao `Watchdog` é 3 vezes o `Ts`, 15 milissegundos, uma folga razoável sobre os 5 milissegundos nominais. O comando de protocolo permite pedir ao alvo, de verdade, que atrase sua resposta antes de escrever de volta no pipe — não é uma simulação de atraso, é o subprocesso C dormindo de fato. No primeiro caso, sem atraso, o resultado é u igual a 10,600 volt, sem estouro de prazo, em 0,26 milissegundo de tempo real. No segundo caso, com atraso deliberado de 200 milissegundos, muito acima do prazo de 15, o resultado é u igual a 0,000 volt, com estouro de prazo confirmado. O tempo real registrado para esse segundo caso chega a 232,52 milissegundos, e vale explicar por quê: a decisão do watchdog, devolver tensão 0, segura, já foi tomada nos 15 milissegundos declarados; o tempo extra é só o custo de encerrar de verdade um processo que continua ocupado dormindo e só consegue processar o comando de encerramento depois de terminar de escrever a resposta pendente no pipe. A decisão de segurança e o custo de desligamento são coisas diferentes, e o script separa as 2 com clareza.
...
4 candidatos são testados: 5, 2, um e meio milissegundo, cada um sob o critério de que o atraso de pior caso não consuma mais que 20 por cento do período. Para `Ts` de 5 milissegundos, o atraso máximo medido é 0,1788 milissegundo, contra um limite de 1,0000 milissegundo: passa com folga. Para 2 milissegundos, atraso máximo 0,0809, limite 0,4000. Para um milissegundo, atraso máximo 0,0731, limite 0,2000. Para meio milissegundo, atraso máximo 0,0696, limite 0,1000: ainda dentro do critério. O script conclui que o menor `Ts` seguro, neste ambiente e com esta margem, é meio milissegundo, o equivalente a 2000 hertz de frequência de amostragem. Vale repetir a ressalva: essa resposta depende do ambiente de execução, não só do algoritmo. Em um firmware bare-metal ou sob sistema operacional de tempo real dedicado, o jitter cairia ordens de grandeza, e o `Ts` mínimo seguro poderia ser bem menor que meio milissegundo.
