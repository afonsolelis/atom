...
- **Marcas de tempo removidas dos decks.** Os slides traziam a posição de cada trecho no vídeo (`TELA: terminal · 04:00–06:30`, `Prof. … · 19:00–20:00`), herdada dos roteiros cronometrados. Numa disciplina EAD o aluno assiste no ritmo dele, e a marca não lhe diz nada — 184 rótulos foram limpos e 18 removidos por só existirem para carregar o horário (os `Slide · MM:SS`). Os roteiros em `unidade_N/roteiros_20min.md` mantêm a cronometragem: lá ela serve à gravação. Também seguem intactos os trechos obrigatórios de vídeos externos no material complementar, que são recorte de conteúdo, não agenda.
