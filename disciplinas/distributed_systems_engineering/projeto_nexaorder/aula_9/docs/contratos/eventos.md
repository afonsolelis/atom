...
Estes eventos ainda não são publicados nesta aula — o transporte continua síncrono até
a Aula 10. Eles são definidos agora porque um contrato de mensagem precisa existir
**antes** do código que o consome, do mesmo jeito que o contrato de API.
