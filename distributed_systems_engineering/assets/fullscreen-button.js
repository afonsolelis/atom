(() => {
  ...
  style.textContent = `
    ...
    .fullscreen-button:focus-visible { outline: 3px solid #f0ce29; outline-offset: 3px; }
    ...
    @media (max-width: 600px) { .fullscreen-button { width: 42px; height: 42px; } }
    @media (prefers-reduced-motion: reduce) { .fullscreen-button { transition: none; } }
    @media print { .fullscreen-button { display: none; } }
  `;
