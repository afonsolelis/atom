...
// "Sobre o professor" split slide (aula1-16; aula0 keeps its own prof slide)
// right after the cover, before the slide-sumario. Idempotent.
const fs = require('fs');
const path = require('path');

const DISC = path.resolve(__dirname, '..', 'data_engineering_and_pipelines');
...
const PROF = `  <section class="slide slide-prof">
    <div class="prof-grid">
      ...
      <div class="prof-lado-escuro">
        ...
        <p class="prof-descricao">Professor e conteudista da UniFECAF, com atuação na área de <strong>dados e tecnologia</strong>. Conduz a disciplina com foco no <em>porquê</em> de cada ferramenta — não só no "como" — e aborda os fundamentos sem assumir conhecimento prévio, sempre conectados à <strong>prática de mercado</strong>.</p>
      </div>
    </div>
  </section>`;
...
for (const deck of deckList()) {
  ...
  // insert only before the FIRST occurrence of the anchor
